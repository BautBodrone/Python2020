def puntajes_GUI():
    ...
    columna_nivel=sg.Column([[sg.Table(facil, headings=["nivel","puntaje","fecha"],hide_vertical_scroll=True,key="t1"),
                  sg.Table(medio, headings=["nivel","puntaje","fecha"],visible=True,hide_vertical_scroll=True,key="t2"),
                  sg.Table(dificil, headings=["nivel","puntaje","fecha"],visible=True,hide_vertical_scroll=True,key="t3")]],
                            key="col_niv",visible=False)

    columna_izq=sg.Column([[sg.Frame("Mostrar puntaje TOP 10 por ", [[sg.Button("Puntaje",key="puntaje",disabled=True),
